    ...
    <main id="main-content">
      ...
      <section id="our-focus" className="v2-expertise"><div className="container">
        ...
        <div className="v2-disciplines">
          <div className="v2-discipline"><Cpu className="v2-discipline-icon" aria-hidden="true" strokeWidth={1.5} /><h3>Engineering</h3><p>Engineering and technical talent supporting complex products, systems, and services.</p></div>
          <div className="v2-discipline"><LifeBuoy className="v2-discipline-icon" aria-hidden="true" strokeWidth={1.5} /><h3>Post-Sales</h3><p>Customer success, implementation, technical support, and service delivery.</p></div>
        </div>
        <p className="v2-industries-label">Industries we serve</p>
        <div className="v2-industries">
          <div className="v2-industry"><img className="v2-industry-img" src={industryHealthcare} alt="Scientists reviewing diagnostic data in a laboratory" /><h4>Healthcare &amp; Life Sciences</h4><p>Engineering, field, and post-sales talent for healthcare, pharmaceutical, and biotechnology companies operating in complex regulatory and technical environments.</p></div>
          <div className="v2-industry"><img className="v2-industry-img" src={industrySecurity} alt="Security team collaborating at workstations" /><h4>Security &amp; Cybersecurity</h4><p>Engineering and post-sales talent for companies building and delivering security and cybersecurity products and services in a competitive, specialized market.</p></div>
          <div className="v2-industry"><img className="v2-industry-img" src={industryManufacturing} alt="Engineers reviewing technical data on a factory floor" /><h4>Manufacturing &amp; Industrial</h4><p>Engineering and technical talent supporting product development, operations, and customer-facing roles in manufacturing and industrial businesses.</p></div>
        </div>
      </div></section>
      ...
      <section className="v2-process" id="how-it-works"><div className="container"><h2>Clarity first. Follow-through throughout.</h2><ol className="v2-steps">{([["Role clarity","Define the work, the success profile, and the expectations.",Target],["Focused search","Bring dedicated focus, with reserved capacity on retained and RMS engagements.",Search],["Structured evaluation","Evaluate consistently and keep stakeholders aligned.",ClipboardCheck],["Offer & handoff","Support the offer and make the transition clear.",BadgeCheck]] as [string,string,React.ElementType][]).map(([title,body,Icon],i)=><li key={title}><Icon className="v2-step-icon" aria-hidden="true" strokeWidth={1.5} /><h3>{title}</h3><p>{body}</p></li>)}</ol><p className="v2-process-note">We track every search in our own system so nothing falls through the cracks.</p></div></section>
      ...
      <section className="v2-contact" id="contact"><div className="container"><p className="eyebrow">LET’S TALK ABOUT THE WORK</p><h2>Ready to discuss a search<br/>or an RMS engagement?</h2><p>No pitch deck. Just a clear discussion about the roles you need to fill.</p><a className="button" href={contact}>Discuss your hiring needs <span aria-hidden="true">↗</span></a><a className="v2-email" href="mailto:c@myrighthire.com">c@myrighthire.com</a></div></section>
    </main><Footer />
  </div>;
}
